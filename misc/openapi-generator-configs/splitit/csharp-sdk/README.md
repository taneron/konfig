...
------------ | ------------- | ------------- | -------------
*InstallmentPlanApi* | [**InstallmentPlanCancel**](docs/InstallmentPlanApi.md#installmentplancancel) | **POST** /api/installmentplans/{installmentPlanNumber}/cancel | 
*InstallmentPlanApi* | [**InstallmentPlanGet**](docs/InstallmentPlanApi.md#installmentplanget) | **GET** /api/installmentplans/{installmentPlanNumber} | 
*InstallmentPlanApi* | [**InstallmentPlanPost**](docs/InstallmentPlanApi.md#installmentplanpost) | **POST** /api/installmentplans | 
*InstallmentPlanApi* | [**InstallmentPlanRefund**](docs/InstallmentPlanApi.md#installmentplanrefund) | **POST** /api/installmentplans/{installmentPlanNumber}/refund | 
*InstallmentPlanApi* | [**InstallmentPlanSearch**](docs/InstallmentPlanApi.md#installmentplansearch) | **GET** /api/installmentplans/search | 
*InstallmentPlanApi* | [**InstallmentPlanUpdateOrder**](docs/InstallmentPlanApi.md#installmentplanupdateorder) | **PUT** /api/installmentplans/{installmentPlanNumber}/updateorder | 
*InstallmentPlanApi* | [**InstallmentPlanUpdateOrder2**](docs/InstallmentPlanApi.md#installmentplanupdateorder2) | **PUT** /api/installmentplans/updateorder | 
*InstallmentPlanApi* | [**InstallmentPlanVerifyAuthorization**](docs/InstallmentPlanApi.md#installmentplanverifyauthorization) | **GET** /api/installmentplans/{installmentPlanNumber}/verifyauthorization | 
