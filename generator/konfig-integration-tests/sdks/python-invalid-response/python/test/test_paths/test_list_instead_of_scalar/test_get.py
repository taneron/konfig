...
from python_invalid_response.paths.list_instead_of_scalar import get
from python_invalid_response import configuration, schemas, api_client

from .. import ApiTestMixin


class TestListInsteadOfScalar(ApiTestMixin, unittest.TestCase):
    """
    ListInsteadOfScalar unit test stubs
    """
