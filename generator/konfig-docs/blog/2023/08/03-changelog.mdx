...
Now `konfig generate` will generate a file named `STATISTICS.md` that contains
`Lines of Code` for each SDK for your API. This file is generated in the same
directory as your `konfig.yaml` file. In the future, we would also like to add
more data such as weekly downloads.
