...
import com.konfigthis.javauseschematitleifpossible.client.ApiCallback;
...
import com.konfigthis.javauseschematitleifpossible.client.ProgressRequestBody;
import com.konfigthis.javauseschematitleifpossible.client.ProgressResponseBody;
...
public class TestApiGenerated {
    ...
    private ApiResponse<AB> fetchWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = fetchValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<AB>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call fetchAsync(final ApiCallback<AB> _callback) throws ApiException {
    ...
    public class FetchRequestBuilder {
         ...
         */
        public AB execute() throws ApiException {
            ApiResponse<AB> localVarResp = fetchWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute fetch request with HTTP info returned
         * @return ApiResponse&lt;AB&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<AB> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<AB> _callback) throws ApiException {
