...
namespace Splitit.Net.Model
{
    ...
    public partial class Installment :  IEquatable<Installment>, IValidatableObject
    {
        ...
        public Installment(int installmentNumber = default(int), decimal amount = default(decimal), DateTime processDateTime = default(DateTime), InstallmentStatus status = default(InstallmentStatus))
        {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for Installment and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for Installment and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        /// </summary>
        [DataMember(Name="InstallmentNumber", EmitDefaultValue=true)]
