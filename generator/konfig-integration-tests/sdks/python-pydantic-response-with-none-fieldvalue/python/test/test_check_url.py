...
import unittest
from python_pydantic_response_with_none_fieldvalue.configuration import check_url
from python_pydantic_response_with_none_fieldvalue.exceptions import InvalidHostConfigurationError
