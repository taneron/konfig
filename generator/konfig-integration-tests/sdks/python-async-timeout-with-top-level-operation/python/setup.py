...
NAME = "python-async-timeout-with-top-level-operation"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="python-async-timeout-with-top-level-operation API",
    author="API Support",
    author_email="support@example.com",
    url="https://github.com/konfig-dev/konfig/tree/main/python",
    keywords=["Konfig", "python-async-timeout-with-top-level-operation API"],
    python_requires=">=3.7",
