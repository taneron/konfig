 ...
 */
extern NSString *const KResponseObjectErrorKey;


@interface KApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<KConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<KResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<KSanitizer> sanitizer;
