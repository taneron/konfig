...
NAME = "python-pydantic-any-schema-dict-response"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="python-pydantic-any-schema-dict-response API",
    author="API Support",
    author_email="support@example.com",
    url="https://github.com/konfig-dev/konfig/tree/main/python",
    keywords=["Konfig", "python-pydantic-any-schema-dict-response API"],
    python_requires=">=3.7",
