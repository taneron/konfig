...
/**
 * EmbeddingAndChunk Class Doc Comment
 *
 * @category Class
 * @package  Carbon
 * @implements \ArrayAccess<string, mixed>
 */
class EmbeddingAndChunk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmbeddingAndChunk';
    ...
    {
        $this->setIfExists('user_file_id', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['user_file_id'];
    }

    /**
     * Sets user_file_id
     *
     * @param int $user_file_id user_file_id
     *
     * @return self
     */
    public function setUserFileId($user_file_id)
    {

        if (is_null($user_file_id)) {
            throw new \InvalidArgumentException('non-nullable user_file_id cannot be null');
        }

        $this->container['user_file_id'] = $user_file_id;
    ...
    {
        return $this->container['source_content'];
    }

    /**
     * Sets source_content
     *
     * @param string $source_content source_content
     *
     * @return self
     */
    public function setSourceContent($source_content)
    {

        if (is_null($source_content)) {
            throw new \InvalidArgumentException('non-nullable source_content cannot be null');
        }

        $this->container['source_content'] = $source_content;
