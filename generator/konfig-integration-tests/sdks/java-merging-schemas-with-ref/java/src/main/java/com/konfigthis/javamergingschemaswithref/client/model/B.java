...
public class B {
  ...
  **/
   ...
   * @return the B instance itself
   */
  public B putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.b, B.b)&&
        Objects.equals(this.additionalProperties, B.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<B>() {
           ...
           public B read(JsonReader in) throws IOException {
             ...
             B instance = thisAdapter.fromJsonTree(jsonObj);
