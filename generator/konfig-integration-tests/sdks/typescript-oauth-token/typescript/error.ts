...
/**
 * This class provides a wrapper for network errors when making requests to typescript-oauth-token API
 */
export class TypescriptOauthTokenClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "TypescriptOauthTokenClientError";
