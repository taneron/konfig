...
NAME = "python-pydantic-nested-union-with-list-and-str"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="python-pydantic-nested-union-with-list-and-str API",
    author="API Support",
    author_email="support@example.com",
    url="https://github.com/konfig-dev/konfig/tree/main/python",
    keywords=["Konfig", "python-pydantic-nested-union-with-list-and-str API"],
    python_requires=">=3.7",
