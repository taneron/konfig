...
#ifndef KDebugLogResponse
#define KDebugLogResponse(response, responseObject,request, error) [[KLogger sharedLogger] logResponse:response responseObject:responseObject request:request error:error];
#endif
 ...
 */
#ifndef KDebugLog
#define KDebugLog(format, ...) [[KLogger sharedLogger] debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];
#endif
...
/**
 * Enabled switch, default NO - default set by KConfiguration debug property
 */
