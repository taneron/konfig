...
namespace CsharpSplitit.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchInstallmentPlanResponseItem")]
    public partial class SearchInstallmentPlanResponseItem : IEquatable<SearchInstallmentPlanResponseItem>, IValidatableObject
    {
        ...
        protected SearchInstallmentPlanResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchInstallmentPlanResponseItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SearchInstallmentPlanResponseItem);
        }

        /// <summary>
        /// Returns true if SearchInstallmentPlanResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchInstallmentPlanResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchInstallmentPlanResponseItem input)
        {
            if (input == null)
            {
                return false;
