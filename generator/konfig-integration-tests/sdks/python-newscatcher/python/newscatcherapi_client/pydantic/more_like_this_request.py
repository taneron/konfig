...
class MoreLikeThisRequest(BaseModel):
    ...
    include_similar_documents: typing.Optional[bool] = Field(None, alias='include_similar_documents')

    similar_documents_number: typing.Optional[int] = Field(None, alias='similar_documents_number')

    similar_documents_fields: typing.Optional[str] = Field(None, alias='similar_documents_fields')
