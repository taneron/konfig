...
describe RubyApiExceptionContainsResponseHeaders::ApiClient do
  ...
  describe '#deserialize' do
    it "handles Array<Integer>" do
      api_client = RubyApiExceptionContainsResponseHeaders::ApiClient.new
  ...
  describe "#object_to_hash" do
    it 'ignores nils and includes empty arrays' do
      ...
      # api_client = RubyApiExceptionContainsResponseHeaders::ApiClient.new
      # _model = RubyApiExceptionContainsResponseHeaders::ModelName.new
  ...
  describe '#build_collection_param' do
    let(:param) { ['aa', 'bb', 'cc'] }
    let(:api_client) { RubyApiExceptionContainsResponseHeaders::ApiClient.new }
