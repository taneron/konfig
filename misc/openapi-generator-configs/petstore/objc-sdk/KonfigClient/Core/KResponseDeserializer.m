#import "KResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const KDeserializationErrorDomainKey = @"KDeserializationErrorDomainKey";

NSInteger const KTypeMismatchErrorCode = 143553;

NSInteger const KEmptyValueOccurredErrorCode = 143509;

NSInteger const KUnknownResponseObjectErrorCode = 143528;


@interface KResponseDeserializer ()
...
@implementation KResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:KDeserializationErrorDomainKey code:KTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:KDeserializationErrorDomainKey code:KEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:KDeserializationErrorDomainKey code:KUnknownResponseObjectErrorCode userInfo:userInfo];
}
