...
/**
 * This class provides a wrapper for network errors when making requests to typescript-optional-api-key API
 */
export class TypescriptOptionalApiKeyError extends Error {
  /**
   * The response body
   */
