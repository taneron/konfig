---
slug: changelog-4
title: "Changelog #4 - Markdown Pages"
...
We are excited to announce the release of [Markdown
Pages](/docs/portal/tutorials/creating-markdown-pages)! This feature allows you
to create a custom documentation page for your API / SDKs. You can use markdown
pages to provide examples, links to external documentation, or any other
information you want to share with your users. Konfig's markdown pages are fully
integrated with the rest of the portal, so you can easily create links to API
endpoints or interactive demos.
