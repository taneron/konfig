...
<div className="max-w-[90vw] block mb-[calc(0.00_*_100%_*_-1)] shadow-lg ">
<div className="scale-80 h-[700px] overflow-scroll origin-top border border-slate-800 p-4 md:p-8">
