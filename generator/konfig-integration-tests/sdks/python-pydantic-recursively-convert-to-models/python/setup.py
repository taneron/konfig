...
NAME = "python-pydantic-recursively-convert-to-models"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="python-pydantic-recursively-convert-to-models API",
    author="API Support",
    author_email="support@example.com",
    url="https://github.com/konfig-dev/konfig/tree/main/python",
    keywords=["Konfig", "python-pydantic-recursively-convert-to-models API"],
    python_requires=">=3.7",
