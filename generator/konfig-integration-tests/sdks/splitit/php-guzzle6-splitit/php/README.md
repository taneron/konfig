...
[![Packagist](https://img.shields.io/badge/Packagist-v2.3.0-blue)](https://packagist.org/packages/konfig/konfig)
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/konfig-dev/konfig/tree/main/php.git"
    }
  ],
  "require": {
    "konfig/konfig/tree/main/php": "2.3.0"
  }
}
```
...
[**InstallmentPlanCancelResponse**](./lib/Model/InstallmentPlanCancelResponse.php)
