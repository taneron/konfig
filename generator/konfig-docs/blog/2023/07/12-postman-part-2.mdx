...
2, we will cover documentation and testing by learning about Collection Runner,
Scripts, and exact testing use cases.


If you want to part 1 or 3 you can navigate to them here:
...
include examples for every <Tooltip tip="An operation for an API is a combination of HTTP Method and sub-path, like 'GET /users'" text="operation"/>
in an API.

Each set of test requests should live under a separate Collection. These
