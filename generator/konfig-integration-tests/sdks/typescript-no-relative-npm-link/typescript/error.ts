...
/**
 * This class provides a wrapper for network errors when making requests to typescript-no-relative-npm-link API
 */
export class TypescriptNoRelativeNpmLinkClientError extends Error {
  /**
   * The response body
   */
