...
public class InlineModelResolver {
        ...
        if (schema.getType() == null || "object".equals(schema.getType())) {
            ...
            if (props != null) {
                for (String propName : props.keySet()) {
                    ...
                    String title = prop.getTitle() == null ? null : prop.getTitle() + "_Property";

                    String schemaName = resolveModelName(title, modelPrefix + "_" + propName);
    ...
    private void flattenComponents() {
        ...
        for (String modelName : modelNames) {
            ...
            if (model.getExtensions() != null && model.getExtensions().get("x-do-not-generate") != null) {
                LOGGER.info("Model {} is not flattened since it has the \"x-do-not-generate\" extension", modelName);
                continue;
            }
