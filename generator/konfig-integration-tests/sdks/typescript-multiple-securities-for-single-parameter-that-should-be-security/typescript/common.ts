        ...
        if (e instanceof AxiosError && e.isAxiosError) {
            try {
                const responseBody =
                    ...
                    : e.response?.data
                throw new TypescriptMultipleSecuritiesForSingleParameterThatShouldBeSecurityClientError(e, parseIfJson(responseBody))
            } catch (innerError) {
                if (innerError instanceof ReferenceError) {
                    ...
                    throw new TypescriptMultipleSecuritiesForSingleParameterThatShouldBeSecurityClientError(e, e.response?.data)
                }
