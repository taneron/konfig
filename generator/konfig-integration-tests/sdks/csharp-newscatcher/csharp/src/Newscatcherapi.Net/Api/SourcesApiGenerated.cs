...
namespace Newscatcherapi.Net.Api
{
    ...
    public partial class SourcesApiGenerated : ISourcesApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SourceResponse)</returns>
        public virtual async System.Threading.Tasks.Task<Newscatcherapi.Net.Client.ApiResponse<SourceResponse>> GetWithHttpInfoAsync(string lang = default(string), string countries = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
