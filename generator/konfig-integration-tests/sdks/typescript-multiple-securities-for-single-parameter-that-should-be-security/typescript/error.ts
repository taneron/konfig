...
/**
 * This class provides a wrapper for network errors when making requests to typescript-multiple-securities-for-single-parameter-that-should-be-security API
 */
export class TypescriptMultipleSecuritiesForSingleParameterThatShouldBeSecurityClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "TypescriptMultipleSecuritiesForSingleParameterThatShouldBeSecurityClientError";
