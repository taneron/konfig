...
class SessionNotFoundError(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["session_id", "error", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["session_id", "error", ], str]):
