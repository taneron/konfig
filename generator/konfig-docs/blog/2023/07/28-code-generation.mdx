...
time and effort than simply writing the intended code. And it doesn't help that AI is a
black box, blurring the feedback loop between prompt experimentation and quality of code generation. When lots of context is required, which is often the case in
larger codebases, the accuracy of the AI drops which can then lead to misleading
or incorrect suggestions.  [Magic](https://magic.dev/), a company building a
software engineer inside your computer, recognizes this limitation and is on a
mission to solve it.
...
[are nobly going all-in on AI-based code generation for
