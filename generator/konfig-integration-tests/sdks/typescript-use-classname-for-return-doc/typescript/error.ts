...
/**
 * This class provides a wrapper for network errors when making requests to typescript-use-classname-for-return-doc API
 */
export class TypescriptUseClassnameForReturnDocClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "TypescriptUseClassnameForReturnDocClientError";
