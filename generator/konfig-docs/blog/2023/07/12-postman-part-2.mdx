---
slug: postman-documentation-testing
title: "Postman, The Ultimate Guide: Documentation & Testing (Part 2)"
authors: dylan
draft: true
tags: [Postman]
---
...
In [part 1](/blog/postman-fundamentals) we covered the fundamentals of Postman
by learning about Workspaces, Collections, Variables, and Authorization. In part
2, we will cover documentation and testing by learning about example requests, Collection Runner,
Scripts, and specific testing techniques.

If you want to read parts 1 or 3 you can navigate to them here:

- [Part 1 (Fundamentals)](/blog/postman-fundamentals)
- Part 2 (Documentation & Testing)
...
To document your API create a Collection of example requests. Example requests
should all live under the same Collection and should include examples for every
<Tooltip tip="An operation for an API is a combination of HTTP Method and sub-path, like 'GET /users'" text="operation"/> in an API. Most public
Collections (e.g. [Salesforce Platform
...
can be categorized as a example requests since it is for documentation.
...
### Running Tagged Requests

(https://community.postman.com/t/how-to-run-postman-requests-using-tags/20628/10)
