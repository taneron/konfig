...
import com.konfigthis.javamergingschemaswithref.client.auth.Authentication;
import com.konfigthis.javamergingschemaswithref.client.auth.HttpBasicAuth;
import com.konfigthis.javamergingschemaswithref.client.auth.HttpBearerAuth;
import com.konfigthis.javamergingschemaswithref.client.auth.ApiKeyAuth;
...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://java-merging-schemas-with-ref.konfigthis.com";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://java-merging-schemas-with-ref.konfigthis.com)
     ...
     * @return a {@link com.konfigthis.javamergingschemaswithref.client.ApiClient} object
     */
     ...
     * @throws com.konfigthis.javamergingschemaswithref.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.konfigthis.javamergingschemaswithref.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.konfigthis.javamergingschemaswithref.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.konfigthis.javamergingschemaswithref.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.konfigthis.javamergingschemaswithref.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.konfigthis.javamergingschemaswithref.client.ApiException If fail to serialize the request body object
     */
     ...
     * @throws com.konfigthis.javamergingschemaswithref.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.konfigthis.javamergingschemaswithref.client.ApiException If fail to serialize the request body object into a string
     */
