...
import { readableStreamToString, TypescriptMultipartFormDataFreeFormObjectClientError, parseIfJson } from "./error";
        ...
        if (e instanceof AxiosError && e.isAxiosError) {
            try {
                const responseBody =
                    ...
                    : e.response?.data
                throw new TypescriptMultipartFormDataFreeFormObjectClientError(e, parseIfJson(responseBody), e.response?.headers)
            } catch (innerError) {
                if (innerError instanceof ReferenceError) {
                    ...
                    throw new TypescriptMultipartFormDataFreeFormObjectClientError(e, e.response?.data, e.response?.headers)
                }
                if (innerError instanceof TypescriptMultipartFormDataFreeFormObjectClientError) {
                    // Got "TypescriptMultipartFormDataFreeFormObjectClientError" from the above try block
                    throw innerError;
                }
