...
NAME = "python-nested-array-items-ref-in-any-of"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="python-nested-array-items-ref-in-any-of API",
    author="API Support",
    author_email="support@example.com",
    url="https://github.com/konfig-dev/konfig/tree/main/python",
    keywords=["Konfig", "python-nested-array-items-ref-in-any-of API"],
    python_requires=">=3.7",
