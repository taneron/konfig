...
@implementation KUserApi

NSString* kKUserApiErrorDomain = @"KUserApiErrorDomain";
NSInteger kKUserApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createUserWithUser: (KUser*) user
    ...
    if (user == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kKUserApiErrorDomain code:kKUserApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
