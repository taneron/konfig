...
class RequiredDtoResponsesLatestHeadlinesResponseArticleResult(TypedDict):
    title: str
...
class DtoResponsesLatestHeadlinesResponseArticleResult(RequiredDtoResponsesLatestHeadlinesResponseArticleResult, OptionalDtoResponsesLatestHeadlinesResponseArticleResult):
    pass
