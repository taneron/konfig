 ...
 */
@ApiModel(description = "Balance of the account")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccountBalance {
  ...
  **/
   ...
   * @return the AccountBalance instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, accountBalance.total)&&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountBalance.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
