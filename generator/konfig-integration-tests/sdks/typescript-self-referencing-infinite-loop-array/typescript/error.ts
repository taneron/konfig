...
/**
 * This class provides a wrapper for network errors when making requests to typescript-self-referencing-infinite-loop-array API
 */
export class TypescriptSelfReferencingSchemaClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown, headers: unknown) {
    ...
    super(message);
    this.name = "TypescriptSelfReferencingSchemaClientError";
