...
/**
 * S3FileSyncInput Class Doc Comment
 *
 * @category Class
 * @package  Carbon
 * @implements \ArrayAccess<string, mixed>
 */
class S3FileSyncInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'S3FileSyncInput';
    ...
    protected static $openAPITypes = [
        'tags' => 'object',
        'ids' => '\Carbon\Model\S3GetFileInput[]',
        'chunk_size' => 'int',
        'chunk_overlap' => 'int',
    ...
    */
     ...
     * Gets ids
     *
     * @return \Carbon\Model\S3GetFileInput[]
     */
