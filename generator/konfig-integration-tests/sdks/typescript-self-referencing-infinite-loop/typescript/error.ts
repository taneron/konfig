...
/**
 * This class provides a wrapper for network errors when making requests to typescript-self-referencing-infinite-loop API
 */
export class TypescriptSelfReferencingInfiniteLoopClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "TypescriptSelfReferencingInfiniteLoopClientError";
