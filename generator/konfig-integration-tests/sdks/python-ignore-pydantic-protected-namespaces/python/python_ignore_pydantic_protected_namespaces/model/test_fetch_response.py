...
class TestFetchResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["model_config_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["model_config_name", ], str]):
