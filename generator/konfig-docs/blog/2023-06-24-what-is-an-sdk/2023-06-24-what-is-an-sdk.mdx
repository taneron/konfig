...
Remove the URL and request body variables as the SDK handles the construction of
both of these.
...
have easily caught incorrect argument names when calling `create()` and `fetch()`.
