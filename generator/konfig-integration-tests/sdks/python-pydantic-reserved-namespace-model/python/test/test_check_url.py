...
import unittest
from python_pydantic_reserved_namespace_model.configuration import check_url
from python_pydantic_reserved_namespace_model.exceptions import InvalidHostConfigurationError
