...
/**
 * This class provides a wrapper for network errors when making requests to typescript-file-upload-node API
 */
export class TypescriptFileUploadNodeClientError extends Error {
  /**
   * The response body
   */
