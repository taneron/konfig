...
Run [`konfig init`](focus://2) to initialize your directory with the necessary
...
You have successfully generated your first SDKs. Once you have generated
SDKs the next steps are to test and publish your SDKs which are made also made
easy by Konfig.
...
<Admonition type="info">
  ...
  [fix](/docs/tutorials/fix-openapi-spec) utilities. Konfig also makes it easy
  to setup Continuous Deployment through [polling an
  endpoint](/docs/tutorials/automate-sdk-updates#polling) or [pushing from
  GitHub repository](/docs/tutorials/automate-sdk-updates#github-action).
  Sometimes its beneficial to add business logic in the SDKs which is also made
  easy by konfig through its [native support for
  customization](/docs/custom-sdks).
</Admonition>
