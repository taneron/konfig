...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.javanullablerefusingallofschema.client.model.TestFetchRequestWithAllOf.CustomTypeAdapterFactory());
