...
${nuget_cmd} install src/Com.Demo/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Com.Demo.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Com.Demo.dll \
-recurse:'src/Com.Demo/*.cs' \
-doc:bin/Com.Demo.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Com.Demo.dll was created successfully"
fi
