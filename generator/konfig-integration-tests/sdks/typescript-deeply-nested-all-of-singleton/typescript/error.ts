...
/**
 * This class provides a wrapper for network errors when making requests to typescript-deeply-nested-all-of-singleton API
 */
export class TypescriptDeeplyNestedAllOfSingletonClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "TypescriptDeeplyNestedAllOfSingletonClientError";
