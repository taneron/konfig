...
class SessionExecuteRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["session_id", "code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["session_id", "code", ], str]):
