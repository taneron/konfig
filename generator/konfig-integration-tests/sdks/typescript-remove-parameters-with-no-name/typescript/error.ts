...
/**
 * This class provides a wrapper for network errors when making requests to typescript-remove-parameters-with-no-name API
 */
export class TypescriptRemoveParametersWithNoNameClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown, headers: unknown) {
    ...
    super(message);
    this.name = "TypescriptRemoveParametersWithNoNameClientError";
