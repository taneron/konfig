...
NAME = "python-pydantic-reserved-namespace-model"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="python-pydantic-reserved-namespace-model API",
    author="API Support",
    author_email="support@example.com",
    url="https://github.com/konfig-dev/konfig/tree/main/python",
    keywords=["Konfig", "python-pydantic-reserved-namespace-model API"],
    python_requires=">=3.7",
