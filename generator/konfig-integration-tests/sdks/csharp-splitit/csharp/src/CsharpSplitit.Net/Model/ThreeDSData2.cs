...
namespace CsharpSplitit.Net.Model
{
    ...
    /// ThreeDSData2
    /// </summary>
    [DataContract(Name = "ThreeDSData2")]
    public partial class ThreeDSData2 : IEquatable<ThreeDSData2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThreeDSData2" /> class.
        /// </summary>
        ...
        public ThreeDSData2(string eCI = default(string), string cAVV = default(string), string xID = default(string), string directoryServerTxnId = default(string), string threeDSVersion = default(string), string transactionId = default(string))
        {
            this.ECI = eCI;
            this.CAVV = cAVV;
            this.XID = xID;
        ...
        {
            return this.Equals(input as ThreeDSData2);
        }

        /// <summary>
        /// Returns true if ThreeDSData2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ThreeDSData2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThreeDSData2 input)
        {
            if (input == null)
            {
                return false;
