...
frequently use Postman to test APIs. So we created the
...
<Figure src="/img/collection-organization.png" caption="Requests are neatly organized in the sidebar. Collections also allow you to group related requests into folders."/>
...
<Figure src="/img/collection-authorization.png" caption="Selecting Authorization types under the 'Authorization' tab for a Collection"/>
...
organize your API documentation and testing.
