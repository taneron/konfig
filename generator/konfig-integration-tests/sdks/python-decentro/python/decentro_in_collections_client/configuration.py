...
from decentro_in_collections_client.exceptions_base import ApiValueError
from decentro_in_collections_client.exceptions import ClientConfigurationError
from decentro_in_collections_client.exceptions import InvalidHostConfigurationError
...
conf = decentro_in_collections_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("decentro_in_collections_client")
    ...
    def auth_settings(self):
        ...
        if 'provider_secret' in self.api_key:
