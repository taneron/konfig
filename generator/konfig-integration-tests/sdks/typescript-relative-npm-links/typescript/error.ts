...
/**
 * This class provides a wrapper for network errors when making requests to typescript-relative-npm-links API
 */
export class TypescriptRelativeNpmLinksClientError extends Error {
  /**
   * The response body
   */
