...
class ProcessingData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ThreeDSData() -> typing.Type['ThreeDSData']:
                return ThreeDSData
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ThreeDSData"]) -> 'ThreeDSData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ThreeDSData"]) -> typing.Union['ThreeDSData', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ThreeDSData: typing.Union['ThreeDSData', schemas.Unset] = schemas.unset,
