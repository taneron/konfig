...
public class AndroidClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public AndroidClientCodegen() {
        ...
        // type: object w/ no other fields is an "AnyType" which is really just Object
        // otherwise this will be set to "oas_any_type_not_mapped" in DefaultCodegen this just produces
        // an import that doesn't exist for Nuitee's SDKs
