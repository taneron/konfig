...
/**
 * OrganizationUserDataSourceFilters Class Doc Comment
 *
 * @category Class
 * @package  Carbon
 * @implements \ArrayAccess<string, mixed>
 */
class OrganizationUserDataSourceFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationUserDataSourceFilters';
    ...
    */
     ...
     * Sets source
     *
     * @param \Carbon\Model\DataSourceTypeNullable|null $source source
     *
     * @return self
     */
     ...
     * Sets revoked_access
     *
     * @param bool|null $revoked_access revoked_access
     *
     * @return self
     */
    public function setRevokedAccess($revoked_access)
    {
        ...
        if (is_null($revoked_access)) {
            array_push($this->openAPINullablesSetToNull, 'revoked_access');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('revoked_access', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
