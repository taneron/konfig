...
imported at any time and used in any runtime. But when process boundaries are
crossed such as HTTP APIs, data validation is not possible to achieve without
code generation; hence the use of code generation in network protocols like
GraphQL, gRPC, and OpenAPI.
...
[Magic](https://magic.dev/), a company building a software engineer inside your computer, recognizes this limitation and is on a mission to solve it.

<Figure src="/img/magic.png" caption={<div>Source: <a href="https://magic.dev/">magic.dev</a></div>}/>
...
<Figure src="/img/mojo.png" caption={<div>Source: <a href="https://www.modular.com/mojo">modular.com/mojo</a></div>}/>
...
which is a common requirement in software engineering. Some disagree with me and
[are nobly going all-in on AI-based code generation for problems that require
100% accuracy](https://blog.darklang.com/gpt/). But from personal prompt
engineering experience with GitHub Copilot, I only see developers leveraging AI
code generation in problem spaces where inaccuracy is acceptable. That being
said, I am I would happily delete our entire codebase if AI can adequately solve
the SDK generation problem.
