...
NAME = "python-api-exception-contains-response-headers"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="python-api-exception-contains-response-headers API",
    author="API Support",
    author_email="support@example.com",
    url="https://github.com/konfig-dev/konfig/tree/main/python",
    keywords=["Konfig", "python-api-exception-contains-response-headers API"],
    python_requires=">=3.7",
