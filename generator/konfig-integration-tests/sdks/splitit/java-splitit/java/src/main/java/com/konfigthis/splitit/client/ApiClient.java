...
import com.konfigthis.splitit.client.auth.Authentication;
import com.konfigthis.splitit.client.auth.HttpBasicAuth;
import com.konfigthis.splitit.client.auth.HttpBearerAuth;
import com.konfigthis.splitit.client.auth.ApiKeyAuth;
import com.konfigthis.splitit.client.auth.OAuth;
import com.konfigthis.splitit.client.auth.RetryingOAuth;
import com.konfigthis.splitit.client.auth.OAuthFlow;
...
public class ApiClient extends ApiClientCustom {
    ...
    private void init() {
        ...
        setUserAgent("Konfig/2.2.2/java");
     ...
     * @return a {@link com.konfigthis.splitit.client.ApiClient} object
     */
     ...
     * @throws com.konfigthis.splitit.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.konfigthis.splitit.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.konfigthis.splitit.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.konfigthis.splitit.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.konfigthis.splitit.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.konfigthis.splitit.client.ApiException If fail to serialize the request body object into a string
     */
