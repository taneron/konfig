...
```kotlin
// Import classes:
//import com.demo.client.infrastructure.*
//import com.demo.client.models.*
...
try {
    ...
    println("4xx response calling PetApi#placeOrder")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PetApi#placeOrder")
    e.printStackTrace()
}
```
