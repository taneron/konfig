...
Run the [`login`](https://www.npmjs.com/package/konfig-cli#konfig-login) command
to set up credentials on your machine to run `konfig generate`. This is necessary
to run `konfig generate`.
...
? What is your Git repository name? konfig-sdks
...
generators:
  java:
    ...
    git:
      userId: konfig-dev
      repoId: konfig-sdks/tree/main/java
  python:
    version: 1.0.0
    ...
    git:
      userId: konfig-dev
      repoId: konfig-sdks/tree/main/python
  typescript:
    version: 1.0.0
    ...
    git:
      userId: konfig-dev
      repoId: konfig-sdks/tree/main/typescript
```
