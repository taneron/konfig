...
namespace Splitit.Net.Model
{
    ...
    public partial class PlanDataModel :  IEquatable<PlanDataModel>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="PurchaseMethod", EmitDefaultValue=true)]
        ...
        public PlanDataModel(decimal totalAmount = default(decimal), string currency = default(string), int numberOfInstallments = default(int), string terminalId = default(string), PurchaseMethod purchaseMethod = default(PurchaseMethod), string refOrderNumber = default(string), Dictionary<string, string> extendedParams = default(Dictionary<string, string>))
        {
            ...
            if (totalAmount == null)
            {
                throw new InvalidDataException("totalAmount is a required property for PlanDataModel and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("numberOfInstallments is a required property for PlanDataModel and cannot be null");
            }
            else
            {
            ...
            // to ensure "purchaseMethod" is required (not null)
            if (purchaseMethod == null)
            {
                throw new InvalidDataException("purchaseMethod is a required property for PlanDataModel and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="NumberOfInstallments", EmitDefaultValue=true)]
