...
/**
 * This class provides a wrapper for network errors when making requests to typescript-preserve-allof-description API
 */
export class TypescriptPreserveAllofDescriptionClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "TypescriptPreserveAllofDescriptionClientError";
