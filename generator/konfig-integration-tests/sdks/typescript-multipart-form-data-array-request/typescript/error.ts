...
/**
 * This class provides a wrapper for network errors when making requests to typescript-multipart-form-data-array-request API
 */
export class TypescriptMultipartFormDataArrayRequestClientError extends Error {
  /**
   * The response body
   */
