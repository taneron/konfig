...
from decentro_in_collections_client.type.generate_payment_link_response_data import GeneratePaymentLinkResponseData

class RequiredGeneratePaymentLinkResponse(TypedDict):
    pass
