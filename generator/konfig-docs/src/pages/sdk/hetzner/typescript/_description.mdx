...
```http
Link: [https://api.hetzner.cloud/v1/actions?page=2&per_page=5](https://api.hetzner.cloud/v1/actions?page=2&per_page=5); rel="prev",
      [https://api.hetzner.cloud/v1/actions?page=4&per_page=5](https://api.hetzner.cloud/v1/actions?page=4&per_page=5); rel="next",
      [https://api.hetzner.cloud/v1/actions?page=6&per_page=5](https://api.hetzner.cloud/v1/actions?page=6&per_page=5); rel="last"
```
