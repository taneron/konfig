...
namespace Com.Demo.Api
{
    ...
    public interface IPetApi : IApiAccessor
    {
        ...
        /// 
        /// </remarks>
        /// <exception cref="Com.Demo.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private Com.Demo.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = new Com.Demo.Client.Configuration { BasePath = basePath };

            ExceptionFactory = Com.Demo.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public PetApi()
        {
            this.Configuration = Com.Demo.Client.Configuration.Default;
        ...
        /// <returns></returns>
        public PetApi(Com.Demo.Client.Configuration configuration = null)
        {
        ...
        public Com.Demo.Client.Configuration Configuration {get; set;}

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Com.Demo.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        public ApiResponse<Order> PlaceOrderWithHttpInfo (Order order)
        {
            ...
            if (order == null)
                throw new ApiException(400, "Missing required parameter 'order' when calling PetApi->PlaceOrder");
