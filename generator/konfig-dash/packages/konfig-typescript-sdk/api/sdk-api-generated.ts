...
// @ts-ignore
import { GenerateRequestBodyAdditionalGeneratorsValue } from '../models';
// @ts-ignore
...
// @ts-ignore
import { GenerateRequestBodyOptionalParametersInner } from '../models';
// @ts-ignore
...
/**
 * SdkApiGenerated - object-oriented interface
 * @export
 * @class SdkApiGenerated
 * @extends {BaseAPI}
 */
export class SdkApiGenerated extends BaseAPI {
    /**
     * Python formatter using the black package
     * @summary Format Python Code
     * @param {SdkApiFormatPythonRequest} requestParameters Request parameters.
