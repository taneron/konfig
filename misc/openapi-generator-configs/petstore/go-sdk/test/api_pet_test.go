...
func Test_demo_PetApiService(t *testing.T) {
    ...
    t.Run("Test PetApiService PlaceOrder", func(t *testing.T) {

        t.Skip("skip test")  // remove to run test

        resp, httpRes, err := apiClient.PetApi.PlaceOrder(context.Background()).Execute()
