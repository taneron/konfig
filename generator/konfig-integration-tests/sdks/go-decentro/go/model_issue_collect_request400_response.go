...
// IssueCollectRequest400Response struct for IssueCollectRequest400Response
type IssueCollectRequest400Response struct {
...
func NewIssueCollectRequest400Response() *IssueCollectRequest400Response {
	this := IssueCollectRequest400Response{}
	return &this
}
...
func (o IssueCollectRequest400Response) MarshalJSON() ([]byte, error) {
...
type NullableIssueCollectRequest400Response struct {
	value *IssueCollectRequest400Response
	isSet bool
}

func (v NullableIssueCollectRequest400Response) Get() *IssueCollectRequest400Response {
	return v.value
}

func (v *NullableIssueCollectRequest400Response) Set(val *IssueCollectRequest400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableIssueCollectRequest400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableIssueCollectRequest400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIssueCollectRequest400Response(val *IssueCollectRequest400Response) *NullableIssueCollectRequest400Response {
	return &NullableIssueCollectRequest400Response{value: val, isSet: true}
}

func (v NullableIssueCollectRequest400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIssueCollectRequest400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
