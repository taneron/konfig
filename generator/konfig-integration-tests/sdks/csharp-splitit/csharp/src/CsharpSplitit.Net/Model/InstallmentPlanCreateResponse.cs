...
namespace CsharpSplitit.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstallmentPlanCreateResponse")]
    public partial class InstallmentPlanCreateResponse : IEquatable<InstallmentPlanCreateResponse>, IValidatableObject
    {
        ...
        protected InstallmentPlanCreateResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstallmentPlanCreateResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InstallmentPlanCreateResponse);
        }

        /// <summary>
        /// Returns true if InstallmentPlanCreateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InstallmentPlanCreateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstallmentPlanCreateResponse input)
        {
            if (input == null)
            {
                return false;
