...
namespace CsharpSplitit.Net.Model
{
    ...
    /// ProcessingData2
    /// </summary>
    [DataContract(Name = "ProcessingData2")]
    public partial class ProcessingData2 : IEquatable<ProcessingData2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessingData2" /> class.
        /// </summary>
        ...
        public ProcessingData2(bool attemptThreeDSecured = default(bool), string softDescriptor = default(string), ThreeDSData2 threeDSData = default(ThreeDSData2))
        {
        ...
        public ThreeDSData2 ThreeDSData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProcessingData2 {\n");
        ...
        {
            return this.Equals(input as ProcessingData2);
        }

        /// <summary>
        /// Returns true if ProcessingData2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessingData2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessingData2 input)
        {
            if (input == null)
            {
                return false;
