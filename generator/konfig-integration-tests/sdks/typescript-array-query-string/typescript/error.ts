...
/**
 * This class provides a wrapper for network errors when making requests to typescript-array-query-string API
 */
export class TypescriptArrayQueryStringClientError extends Error {
  /**
   * The response body
   */
