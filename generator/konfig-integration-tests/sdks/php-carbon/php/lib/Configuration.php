...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.carbon.ai';
     ...
     * @var string
     */
    protected $userAgent = 'Konfig/0.1.1/PHP';
    ...
    )
    {
        ...
        $this->setApiKey("accessToken", $accessToken);
        $this->setApiKeyPrefix("accessToken", "Token ");
        $this->setApiKey("apiKey", $apiKey);
        $this->setApiKeyPrefix("apiKey", "Bearer ");
        $this->setApiKey("customerId", $customerId);
    }
    ...
    {
        $report  = 'PHP SDK (Carbon) Debug Report:' . PHP_EOL;
