...
/**
 * This class provides a wrapper for network errors when making requests to typescript-client-state-with-configuration API
 */
export class TypescriptClientStateWithConfigurationClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "TypescriptClientStateWithConfigurationClientError";
