...
using CsharpSplitit.Net.Client.Auth;
using CsharpSplitit.Net.Model;

namespace CsharpSplitit.Net.Api
{
    ...
    public interface IInstallmentPlanApiSync : IApiAccessor
    {
        ...
        /// 
        /// </summary>
        /// <exception cref="CsharpSplitit.Net.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        InitiatePlanResponse Post(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanInitiateRequest installmentPlanInitiateRequest, string xSplititTestMode = default(string), int operationIndex = 0);
        ...
        ApiResponse<InitiatePlanResponse> PostWithHttpInfo(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanInitiateRequest installmentPlanInitiateRequest, string xSplititTestMode = default(string), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="CsharpSplitit.Net.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        InstallmentPlanCreateResponse Post2(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanCreateRequest installmentPlanCreateRequest, string xSplititTestMode = default(string), int operationIndex = 0);
        ...
        ApiResponse<InstallmentPlanCreateResponse> Post2WithHttpInfo(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanCreateRequest installmentPlanCreateRequest, string xSplititTestMode = default(string), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="CsharpSplitit.Net.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IInstallmentPlanApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InitiatePlanResponse> PostAsync(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanInitiateRequest installmentPlanInitiateRequest, string xSplititTestMode = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<InstallmentPlanCreateResponse> Post2Async(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanCreateRequest installmentPlanCreateRequest, string xSplititTestMode = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class InstallmentPlanApiGenerated : IInstallmentPlanApi
    {
        private CsharpSplitit.Net.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="InstallmentPlanApiGenerated"/> class.
        /// </summary>
        /// <returns></returns>
        public InstallmentPlanApiGenerated() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public InstallmentPlanApiGenerated(string basePath)
        {
            this.Configuration = CsharpSplitit.Net.Client.Configuration.MergeConfigurations(
                CsharpSplitit.Net.Client.GlobalConfiguration.Instance,
                new CsharpSplitit.Net.Client.Configuration { BasePath = basePath }
            );
            this.Client = new CsharpSplitit.Net.Client.ApiClient(this.Configuration);
            this.AsynchronousClient = new CsharpSplitit.Net.Client.ApiClient(this.Configuration);
            this.ExceptionFactory = CsharpSplitit.Net.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public InstallmentPlanApiGenerated(CsharpSplitit.Net.Client.Configuration configuration)
        {
        ...
        public InstallmentPlanApiGenerated(CsharpSplitit.Net.Client.ISynchronousClient client, CsharpSplitit.Net.Client.IAsynchronousClient asyncClient, CsharpSplitit.Net.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public CsharpSplitit.Net.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public CsharpSplitit.Net.Client.ISynchronousClient Client { get; set; }
        ...
        public CsharpSplitit.Net.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public CsharpSplitit.Net.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanCancelResponse> localVarResponse = CancelWithHttpInfo(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InstallmentPlanCancelResponse</returns>
        public CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanCancelResponse> CancelWithHttpInfo(string installmentPlanNumber, string xSplititIdempotencyKey, string xSplititTouchPoint, int operationIndex = 0)
        {
            // verify the required parameter 'installmentPlanNumber' is set
            if (installmentPlanNumber == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'installmentPlanNumber' when calling InstallmentPlanApi->Cancel");
            }

            // verify the required parameter 'xSplititIdempotencyKey' is set
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->Cancel");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->Cancel");
            }
            ...
            var localVarAccept = CsharpSplitit.Net.Client.ClientUtils.SelectHeaderAccept(_accepts);
            if (localVarAccept != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Accept", localVarAccept);
            }

            localVarRequestOptions.PathParameters.Add("installmentPlanNumber", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(installmentPlanNumber)); // path parameter
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-IdempotencyKey", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititIdempotencyKey)); // header parameter
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-TouchPoint", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititTouchPoint)); // header parameter
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanCancelResponse> localVarResponse = await CancelWithHttpInfoAsync(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public virtual async System.Threading.Tasks.Task<CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanCancelResponse>> CancelWithHttpInfoAsync(string installmentPlanNumber, string xSplititIdempotencyKey, string xSplititTouchPoint, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            localVarRequestOptions.PathParameters.Add("installmentPlanNumber", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(installmentPlanNumber)); // path parameter
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-IdempotencyKey", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititIdempotencyKey, dataFormat: "")); // header parameter
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-TouchPoint", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititTouchPoint, dataFormat: "")); // header parameter
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentsEligibilityResponse> localVarResponse = CheckEligibilityWithHttpInfo(xSplititIdempotencyKey, xSplititTouchPoint, checkInstallmentsEligibilityRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InstallmentsEligibilityResponse</returns>
        public CsharpSplitit.Net.Client.ApiResponse<InstallmentsEligibilityResponse> CheckEligibilityWithHttpInfo(string xSplititIdempotencyKey, string xSplititTouchPoint, CheckInstallmentsEligibilityRequest checkInstallmentsEligibilityRequest, int operationIndex = 0)
        {
            // verify the required parameter 'xSplititIdempotencyKey' is set
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->CheckEligibility");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->CheckEligibility");
            }

            // verify the required parameter 'checkInstallmentsEligibilityRequest' is set
            if (checkInstallmentsEligibilityRequest == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'checkInstallmentsEligibilityRequest' when calling InstallmentPlanApi->CheckEligibility");
            }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentsEligibilityResponse> localVarResponse = await CheckEligibilityWithHttpInfoAsync(xSplititIdempotencyKey, xSplititTouchPoint, checkInstallmentsEligibilityRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanGetResponse> localVarResponse = GetWithHttpInfo(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InstallmentPlanGetResponse</returns>
        public CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanGetResponse> GetWithHttpInfo(string installmentPlanNumber, string xSplititIdempotencyKey, string xSplititTouchPoint, int operationIndex = 0)
        {
            // verify the required parameter 'installmentPlanNumber' is set
            if (installmentPlanNumber == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'installmentPlanNumber' when calling InstallmentPlanApi->Get");
            }

            // verify the required parameter 'xSplititIdempotencyKey' is set
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->Get");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->Get");
            }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanGetResponse> localVarResponse = await GetWithHttpInfoAsync(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>InitiatePlanResponse</returns>
        public InitiatePlanResponse Post(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanInitiateRequest installmentPlanInitiateRequest, string xSplititTestMode = default(string), int operationIndex = 0)
        {
            CsharpSplitit.Net.Client.ApiResponse<InitiatePlanResponse> localVarResponse = PostWithHttpInfo(xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanInitiateRequest, xSplititTestMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InitiatePlanResponse</returns>
        public CsharpSplitit.Net.Client.ApiResponse<InitiatePlanResponse> PostWithHttpInfo(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanInitiateRequest installmentPlanInitiateRequest, string xSplititTestMode = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'xSplititIdempotencyKey' is set
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->Post");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->Post");
            }

            // verify the required parameter 'installmentPlanInitiateRequest' is set
            if (installmentPlanInitiateRequest == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'installmentPlanInitiateRequest' when calling InstallmentPlanApi->Post");
            }
            ...
            {
                localVarRequestOptions.HeaderParameters.Add("X-Splitit-TestMode", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititTestMode)); // header parameter
            }
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-IdempotencyKey", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititIdempotencyKey)); // header parameter
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-TouchPoint", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititTouchPoint)); // header parameter
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InitiatePlanResponse> localVarResponse = await PostWithHttpInfoAsync(xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanInitiateRequest, xSplititTestMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public virtual async System.Threading.Tasks.Task<CsharpSplitit.Net.Client.ApiResponse<InitiatePlanResponse>> PostWithHttpInfoAsync(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanInitiateRequest installmentPlanInitiateRequest, string xSplititTestMode = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (xSplititTestMode != null)
            {
                localVarRequestOptions.HeaderParameters.Add("X-Splitit-TestMode", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititTestMode, dataFormat: "")); // header parameter
            }
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-IdempotencyKey", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititIdempotencyKey, dataFormat: "")); // header parameter
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-TouchPoint", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititTouchPoint, dataFormat: "")); // header parameter
            localVarRequestOptions.Data = installmentPlanInitiateRequest;
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>InstallmentPlanCreateResponse</returns>
        public InstallmentPlanCreateResponse Post2(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanCreateRequest installmentPlanCreateRequest, string xSplititTestMode = default(string), int operationIndex = 0)
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanCreateResponse> localVarResponse = Post2WithHttpInfo(xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanCreateRequest, xSplititTestMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InstallmentPlanCreateResponse</returns>
        public CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanCreateResponse> Post2WithHttpInfo(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanCreateRequest installmentPlanCreateRequest, string xSplititTestMode = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'xSplititIdempotencyKey' is set
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->Post2");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->Post2");
            }

            // verify the required parameter 'installmentPlanCreateRequest' is set
            if (installmentPlanCreateRequest == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'installmentPlanCreateRequest' when calling InstallmentPlanApi->Post2");
            }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanCreateResponse> localVarResponse = await Post2WithHttpInfoAsync(xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanCreateRequest, xSplititTestMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanRefundResponse> localVarResponse = RefundWithHttpInfo(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanRefundRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InstallmentPlanRefundResponse</returns>
        public CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanRefundResponse> RefundWithHttpInfo(string installmentPlanNumber, string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanRefundRequest installmentPlanRefundRequest, int operationIndex = 0)
        {
            // verify the required parameter 'installmentPlanNumber' is set
            if (installmentPlanNumber == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'installmentPlanNumber' when calling InstallmentPlanApi->Refund");
            }

            // verify the required parameter 'xSplititIdempotencyKey' is set
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->Refund");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->Refund");
            }

            // verify the required parameter 'installmentPlanRefundRequest' is set
            if (installmentPlanRefundRequest == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'installmentPlanRefundRequest' when calling InstallmentPlanApi->Refund");
            }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanRefundResponse> localVarResponse = await RefundWithHttpInfoAsync(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanRefundRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanSearchResponse> localVarResponse = SearchWithHttpInfo(xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanNumber, refOrderNumber, extendedParams);
            return localVarResponse.Data;
        }
        ...
        public CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanSearchResponse> SearchWithHttpInfo(string xSplititIdempotencyKey, string xSplititTouchPoint, string installmentPlanNumber = default(string), string refOrderNumber = default(string), Dictionary<string, string> extendedParams = default(Dictionary<string, string>), int operationIndex = 0)
        {
            ...
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->Search");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->Search");
            }
            ...
            if (installmentPlanNumber != null)
            {
                localVarRequestOptions.QueryParameters.Add(CsharpSplitit.Net.Client.ClientUtils.ParameterToMultiMap("", "installmentPlanNumber", installmentPlanNumber, ""));
            }
            if (refOrderNumber != null)
            {
                localVarRequestOptions.QueryParameters.Add(CsharpSplitit.Net.Client.ClientUtils.ParameterToMultiMap("", "refOrderNumber", refOrderNumber, ""));
            }
            if (extendedParams != null)
            {
                localVarRequestOptions.QueryParameters.Add(CsharpSplitit.Net.Client.ClientUtils.ParameterToMultiMap("", "extendedParams", extendedParams, ""));
            }
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-IdempotencyKey", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititIdempotencyKey)); // header parameter
            localVarRequestOptions.HeaderParameters.Add("X-Splitit-TouchPoint", CsharpSplitit.Net.Client.ClientUtils.ParameterToString(xSplititTouchPoint)); // header parameter
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanSearchResponse> localVarResponse = await SearchWithHttpInfoAsync(xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanNumber, refOrderNumber, extendedParams, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanUpdateResponse> localVarResponse = UpdateOrderWithHttpInfo(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint, updateOrderRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InstallmentPlanUpdateResponse</returns>
        public CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanUpdateResponse> UpdateOrderWithHttpInfo(string installmentPlanNumber, string xSplititIdempotencyKey, string xSplititTouchPoint, UpdateOrderRequest updateOrderRequest, int operationIndex = 0)
        {
            // verify the required parameter 'installmentPlanNumber' is set
            if (installmentPlanNumber == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'installmentPlanNumber' when calling InstallmentPlanApi->UpdateOrder");
            }

            // verify the required parameter 'xSplititIdempotencyKey' is set
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->UpdateOrder");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->UpdateOrder");
            }

            // verify the required parameter 'updateOrderRequest' is set
            if (updateOrderRequest == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'updateOrderRequest' when calling InstallmentPlanApi->UpdateOrder");
            }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanUpdateResponse> localVarResponse = await UpdateOrderWithHttpInfoAsync(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint, updateOrderRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanUpdateResponse> localVarResponse = UpdateOrder2WithHttpInfo(xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanUpdateRequestByIdentifier);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InstallmentPlanUpdateResponse</returns>
        public CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanUpdateResponse> UpdateOrder2WithHttpInfo(string xSplititIdempotencyKey, string xSplititTouchPoint, InstallmentPlanUpdateRequestByIdentifier installmentPlanUpdateRequestByIdentifier, int operationIndex = 0)
        {
            // verify the required parameter 'xSplititIdempotencyKey' is set
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->UpdateOrder2");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->UpdateOrder2");
            }
            ...
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'installmentPlanUpdateRequestByIdentifier' when calling InstallmentPlanApi->UpdateOrder2");
            }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<InstallmentPlanUpdateResponse> localVarResponse = await UpdateOrder2WithHttpInfoAsync(xSplititIdempotencyKey, xSplititTouchPoint, installmentPlanUpdateRequestByIdentifier, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<VerifyAuthorizationResponse> localVarResponse = VerifyAuthorizationWithHttpInfo(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of VerifyAuthorizationResponse</returns>
        public CsharpSplitit.Net.Client.ApiResponse<VerifyAuthorizationResponse> VerifyAuthorizationWithHttpInfo(string installmentPlanNumber, string xSplititIdempotencyKey, string xSplititTouchPoint, int operationIndex = 0)
        {
            // verify the required parameter 'installmentPlanNumber' is set
            if (installmentPlanNumber == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'installmentPlanNumber' when calling InstallmentPlanApi->VerifyAuthorization");
            }

            // verify the required parameter 'xSplititIdempotencyKey' is set
            if (xSplititIdempotencyKey == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititIdempotencyKey' when calling InstallmentPlanApi->VerifyAuthorization");
            }

            // verify the required parameter 'xSplititTouchPoint' is set
            if (xSplititTouchPoint == null)
            {
                throw new CsharpSplitit.Net.Client.ApiException(400, "Missing required parameter 'xSplititTouchPoint' when calling InstallmentPlanApi->VerifyAuthorization");
            }
        ...
        {
            CsharpSplitit.Net.Client.ApiResponse<VerifyAuthorizationResponse> localVarResponse = await VerifyAuthorizationWithHttpInfoAsync(installmentPlanNumber, xSplititIdempotencyKey, xSplititTouchPoint, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
