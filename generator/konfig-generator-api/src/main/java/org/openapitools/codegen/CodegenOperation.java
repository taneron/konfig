...
public class CodegenOperation {
    ...
    // This is populated in the case where we flatten request body properties into a single parameter object
    ...
    public Map<String, Object> operationVendorExtensions;
    ...
    public CodegenOperation() {
        // copy this to avoid naming conflict with parameter scope in mustache
        this.operationVendorExtensions = this.vendorExtensions;
    }
