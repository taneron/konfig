...
/**
 * This class provides a wrapper for network errors when making requests to typescript-multipart-form-data-free-form-object API
 */
export class TypescriptMultipartFormDataFreeFormObjectClientError extends Error {
  /**
   * The response body
   */
