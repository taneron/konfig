...
extern NSString * KPercentEscapedStringFromString(NSString *string);

extern NSString * const kKApplicationJSONType;

@protocol KSanitizer <NSObject>
...
@interface KSanitizer : NSObject <KSanitizer>
