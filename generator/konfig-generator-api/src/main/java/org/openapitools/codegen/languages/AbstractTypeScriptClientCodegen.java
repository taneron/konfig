...
public abstract class AbstractTypeScriptClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    private String toSafeIdentifier(String name) {
        return toSafeIdentifier(name, true);
    }

    private String toSafeIdentifier(String name, boolean checkReservedWords) {
        if ((checkReservedWords && isReservedWord(name)) || name.matches("^\\d.*")) {
    ...
    public String getTypeDeclaration(Schema p) {
        if (ModelUtils.isArraySchema(p)) {
            ...
            return "Uint8Array | File | buffer.File";
    ...
    public String toOperationId(String operationId) {
        ...
        // This use to escape reserved keywords but they actually aren't a problem for method names
        operationId = toSafeIdentifier(operationId, false);
