...
import com.konfigthis.javamergedschemashaveencapsulatingname.client.auth.Authentication;
import com.konfigthis.javamergedschemashaveencapsulatingname.client.auth.HttpBasicAuth;
import com.konfigthis.javamergedschemashaveencapsulatingname.client.auth.HttpBearerAuth;
import com.konfigthis.javamergedschemashaveencapsulatingname.client.auth.ApiKeyAuth;
...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://java-merged-schemas-have-encapsulating-name.konfigthis.com";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://java-merged-schemas-have-encapsulating-name.konfigthis.com)
     ...
     * @return a {@link com.konfigthis.javamergedschemashaveencapsulatingname.client.ApiClient} object
     */
     ...
     * @throws com.konfigthis.javamergedschemashaveencapsulatingname.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.konfigthis.javamergedschemashaveencapsulatingname.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.konfigthis.javamergedschemashaveencapsulatingname.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.konfigthis.javamergedschemashaveencapsulatingname.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.konfigthis.javamergedschemashaveencapsulatingname.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.konfigthis.javamergedschemashaveencapsulatingname.client.ApiException If fail to serialize the request body object
     */
     ...
     * @throws com.konfigthis.javamergedschemashaveencapsulatingname.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.konfigthis.javamergedschemashaveencapsulatingname.client.ApiException If fail to serialize the request body object into a string
     */
