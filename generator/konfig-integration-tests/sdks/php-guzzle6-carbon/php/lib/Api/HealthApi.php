...
class HealthApi extends \Carbon\CustomApi
{
    /**
     * @var ClientInterface
     */
...
/**
     ...
     */
    public function checkWithHttpInfo(string $contentType = self::contentTypes['check'][0], \Carbon\RequestOptions $requestOptions = new \Carbon\RequestOptions())
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkAsyncWithHttpInfo(string $contentType = self::contentTypes['check'][0], \Carbon\RequestOptions $requestOptions = new \Carbon\RequestOptions())
    {
        $returnType = 'object';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->checkRequest($contentType);
