...
// FSearchResponse2 struct for FSearchResponse2
type FSearchResponse2 struct {
	Status *string `json:"status,omitempty"`
	TotalHits *int32 `json:"total_hits,omitempty"`
	Page *int32 `json:"page,omitempty"`
	TotalPages *int32 `json:"total_pages,omitempty"`
	PageSize *int32 `json:"page_size,omitempty"`
	Articles []ArticlesPropertyInner2 `json:"articles,omitempty"`
...
func (o *FSearchResponse2) GetArticles() []ArticlesPropertyInner2 {
	if o == nil || isNil(o.Articles) {
		var ret []ArticlesPropertyInner2
		return ret
	}
	return o.Articles
}
...
// SetArticles gets a reference to the given []ArticlesPropertyInner2 and assigns it to the Articles field.
...
func (o FSearchResponse2) MarshalJSON() ([]byte, error) {
...
type NullableFSearchResponse2 struct {
	value *FSearchResponse2
	isSet bool
}

func (v NullableFSearchResponse2) Get() *FSearchResponse2 {
	return v.value
}

func (v *NullableFSearchResponse2) Set(val *FSearchResponse2) {
	v.value = val
	v.isSet = true
}

func (v NullableFSearchResponse2) IsSet() bool {
	return v.isSet
}

func (v *NullableFSearchResponse2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFSearchResponse2(val *FSearchResponse2) *NullableFSearchResponse2 {
	return &NullableFSearchResponse2{value: val, isSet: true}
}

func (v NullableFSearchResponse2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFSearchResponse2) UnmarshalJSON(src []byte) error {
	v.isSet = true
