...
import { readableStreamToString, TypescriptClientStateWithConfigurationClientError, parseIfJson } from "./error";
        ...
        if (e instanceof AxiosError && e.isAxiosError) {
            try {
                const responseBody =
                    ...
                    : e.response?.data
                throw new TypescriptClientStateWithConfigurationClientError(e, parseIfJson(responseBody), e.response?.headers)
            } catch (innerError) {
                if (innerError instanceof ReferenceError) {
                    ...
                    throw new TypescriptClientStateWithConfigurationClientError(e, e.response?.data, e.response?.headers)
                }
                if (innerError instanceof TypescriptClientStateWithConfigurationClientError) {
                    // Got "TypescriptClientStateWithConfigurationClientError" from the above try block
                    throw innerError;
                }
