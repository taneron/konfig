...
${nuget_cmd} install src/Splitit.Net/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Splitit.Net.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Splitit.Net.dll \
-recurse:'src/Splitit.Net/*.cs' \
-doc:bin/Splitit.Net.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Splitit.Net.dll was created successfully"
fi
