...
from python_splitit_client.model.installment_plan_refund_response import InstallmentPlanRefundResponse as InstallmentPlanRefundResponseSchema
    ...
    async def _arefund_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/installmentplans/{installmentPlanNumber}/refund',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
