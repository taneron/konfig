...
public class CodegenComposedSchemas {
    ...
    boolean hasMultipleAllOf;
    boolean hasMultipleOneOf;
    boolean hasMultipleAnyOf;
    ...
    public CodegenComposedSchemas(List<CodegenProperty> allOf, List<CodegenProperty> oneOf, List<CodegenProperty> anyOf, CodegenProperty not) {
        ...
        this.anyOf = anyOf;
        this.not = not;
        this. hasMultipleAllOf = allOf != null && allOf.size() > 1;
        this. hasMultipleOneOf = oneOf != null && oneOf.size() > 1;
        this. hasMultipleAnyOf = anyOf != null && anyOf.size() > 1;
    }
