...
NAME = "python-one-of-uuid-string-integer-path-parameter"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="python-one-of-uuid-string-integer-path-parameter API",
    author="API Support",
    author_email="support@example.com",
    url="https://github.com/konfig-dev/konfig/tree/main/python",
    keywords=["Konfig", "python-one-of-uuid-string-integer-path-parameter API"],
    python_requires=">=3.7",
