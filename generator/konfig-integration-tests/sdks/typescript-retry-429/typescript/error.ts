...
/**
 * This class provides a wrapper for network errors when making requests to typescript-retry-429 API
 */
export class TypescriptRetry429ClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown, headers: unknown) {
    ...
    super(message);
    this.name = "TypescriptRetry429ClientError";
