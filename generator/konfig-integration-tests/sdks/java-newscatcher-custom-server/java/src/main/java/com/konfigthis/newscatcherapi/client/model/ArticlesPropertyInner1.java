...
public class ArticlesPropertyInner1 {
  ...
  public ArticlesPropertyInner1 title(String title) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 description(String description) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 author(String author) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 authors(Object authors) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 journalists(Object journalists) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 publishedDate(String publishedDate) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 publishedDatePrecision(String publishedDatePrecision) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 updatedDate(String updatedDate) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 updatedDatePrecision(String updatedDatePrecision) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 parseDate(String parseDate) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 link(String link) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 domainUrl(String domainUrl) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 fullDomainUrl(String fullDomainUrl) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 nameSource(String nameSource) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 isHeadline(String isHeadline) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 paidContent(Boolean paidContent) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 extractionData(String extractionData) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 country(String country) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 rights(String rights) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 rank(Integer rank) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 media(String media) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 language(String language) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 content(String content) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 wordCount(Integer wordCount) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 isOpinion(Boolean isOpinion) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 twitterAccount(String twitterAccount) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 allLinks(Object allLinks) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 allDomainLinks(Object allDomainLinks) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 nlp(Object nlp) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 id(String id) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 score(Double score) {
  ...
  public ArticlesPropertyInner1 score(Integer score) {
  ...
  **/
  ...
  public ArticlesPropertyInner1 similarDocuments(List<SimilarDocument1> similarDocuments) {
  ...
  public ArticlesPropertyInner1 addSimilarDocumentsItem(SimilarDocument1 similarDocumentsItem) {
  ...
  **/
   ...
   * @return the ArticlesPropertyInner1 instance itself
   */
  public ArticlesPropertyInner1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ArticlesPropertyInner1 articlesPropertyInner1 = (ArticlesPropertyInner1) o;
    return Objects.equals(this.title, articlesPropertyInner1.title) &&
        Objects.equals(this.description, articlesPropertyInner1.description) &&
        Objects.equals(this.author, articlesPropertyInner1.author) &&
        Objects.equals(this.authors, articlesPropertyInner1.authors) &&
        Objects.equals(this.journalists, articlesPropertyInner1.journalists) &&
        Objects.equals(this.publishedDate, articlesPropertyInner1.publishedDate) &&
        Objects.equals(this.publishedDatePrecision, articlesPropertyInner1.publishedDatePrecision) &&
        Objects.equals(this.updatedDate, articlesPropertyInner1.updatedDate) &&
        Objects.equals(this.updatedDatePrecision, articlesPropertyInner1.updatedDatePrecision) &&
        Objects.equals(this.parseDate, articlesPropertyInner1.parseDate) &&
        Objects.equals(this.link, articlesPropertyInner1.link) &&
        Objects.equals(this.domainUrl, articlesPropertyInner1.domainUrl) &&
        Objects.equals(this.fullDomainUrl, articlesPropertyInner1.fullDomainUrl) &&
        Objects.equals(this.nameSource, articlesPropertyInner1.nameSource) &&
        Objects.equals(this.isHeadline, articlesPropertyInner1.isHeadline) &&
        Objects.equals(this.paidContent, articlesPropertyInner1.paidContent) &&
        Objects.equals(this.extractionData, articlesPropertyInner1.extractionData) &&
        Objects.equals(this.country, articlesPropertyInner1.country) &&
        Objects.equals(this.rights, articlesPropertyInner1.rights) &&
        Objects.equals(this.rank, articlesPropertyInner1.rank) &&
        Objects.equals(this.media, articlesPropertyInner1.media) &&
        Objects.equals(this.language, articlesPropertyInner1.language) &&
        Objects.equals(this.content, articlesPropertyInner1.content) &&
        Objects.equals(this.wordCount, articlesPropertyInner1.wordCount) &&
        Objects.equals(this.isOpinion, articlesPropertyInner1.isOpinion) &&
        Objects.equals(this.twitterAccount, articlesPropertyInner1.twitterAccount) &&
        Objects.equals(this.allLinks, articlesPropertyInner1.allLinks) &&
        Objects.equals(this.allDomainLinks, articlesPropertyInner1.allDomainLinks) &&
  ...
  public String toString() {
    ...
    sb.append("class ArticlesPropertyInner1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ArticlesPropertyInner1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ArticlesPropertyInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ArticlesPropertyInner1 is not found in the empty JSON string", ArticlesPropertyInner1.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("full_domain_url") != null && !jsonObj.get("full_domain_url").isJsonNull()) && !jsonObj.get("full_domain_url").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("extraction_data") != null && !jsonObj.get("extraction_data").isJsonNull()) && !jsonObj.get("extraction_data").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ArticlesPropertyInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ArticlesPropertyInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ArticlesPropertyInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ArticlesPropertyInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<ArticlesPropertyInner1>() {
           @Override
           public void write(JsonWriter out, ArticlesPropertyInner1 value) throws IOException {
           ...
           @Override
           public ArticlesPropertyInner1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ArticlesPropertyInner1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ArticlesPropertyInner1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ArticlesPropertyInner1
  * @throws IOException if the JSON string is invalid with respect to ArticlesPropertyInner1
  */
  public static ArticlesPropertyInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ArticlesPropertyInner1.class);
  }

 /**
  * Convert an instance of ArticlesPropertyInner1 to an JSON string
  *
  * @return JSON string
  */
