...
/**
 * This class provides a wrapper for network errors when making requests to API
 */
export class TypescriptQueryParamsNotIncludedInBodyClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "TypescriptQueryParamsNotIncludedInBodyClientError";
