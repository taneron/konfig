...
public class C {
  ...
  **/
   ...
   * @return the C instance itself
   */
  public C putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.c, C.c)&&
        Objects.equals(this.additionalProperties, C.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<C>() {
           ...
           public C read(JsonReader in) throws IOException {
             ...
             C instance = thisAdapter.fromJsonTree(jsonObj);
