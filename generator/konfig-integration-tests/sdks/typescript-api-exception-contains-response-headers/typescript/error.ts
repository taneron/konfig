...
/**
 * This class provides a wrapper for network errors when making requests to typescript-api-exception-contains-response-headers API
 */
export class TypescriptApiExceptionContainsResponseHeadersClientError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown, headers: unknown) {
    ...
    super(message);
    this.name = "TypescriptApiExceptionContainsResponseHeadersClientError";
