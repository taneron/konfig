...
class GetTransactionStatusResponseError(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            response_code = schemas.StrSchema
            __annotations__ = {
                "message": message,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "response_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "response_code", ], str]):
