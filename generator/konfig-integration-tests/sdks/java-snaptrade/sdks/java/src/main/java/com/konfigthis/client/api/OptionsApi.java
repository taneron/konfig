...
public class OptionsApi extends OptionsApiGenerated {
    ...
    public class PlaceOptionStrategyRequestBuilder extends PlaceOptionStrategyRequestBuilderGenerated {
        public PlaceOptionStrategyRequestBuilder(OrderType orderType, TimeInForceStrict timeInForce, String userId, String userSecret, UUID accountId, UUID optionStrategyId) {
