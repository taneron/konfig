...
open class PetAPI {
     ...
     */
    @discardableResult
    open class func addPet(pet: Pet, apiResponseQueue: DispatchQueue = DemoAPI.apiResponseQueue, completion: @escaping ((_ data: Pet?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func addPetWithRequestBuilder(pet: Pet) -> RequestBuilder<Pet> {
        ...
        let localVariableURLString = DemoAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<Pet>.Type = DemoAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func deletePet(petId: Int64, apiKey: String? = nil, apiResponseQueue: DispatchQueue = DemoAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func deletePetWithRequestBuilder(petId: Int64, apiKey: String? = nil) -> RequestBuilder<Void> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Void>.Type = DemoAPI.requestBuilderFactory.getNonDecodableBuilder()
     ...
     */
    @discardableResult
    open class func findPetsByStatus(status: [Status_findPetsByStatus], apiResponseQueue: DispatchQueue = DemoAPI.apiResponseQueue, completion: @escaping ((_ data: [Pet]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    @discardableResult
    open class func findPetsByTags(tags: [String], apiResponseQueue: DispatchQueue = DemoAPI.apiResponseQueue, completion: @escaping ((_ data: [Pet]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getPetById(petId: Int64, apiResponseQueue: DispatchQueue = DemoAPI.apiResponseQueue, completion: @escaping ((_ data: Pet?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func placeOrder(order: Order, apiResponseQueue: DispatchQueue = DemoAPI.apiResponseQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func placeOrderWithRequestBuilder(order: Order) -> RequestBuilder<Order> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Order>.Type = DemoAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func updatePet(pet: Pet, apiResponseQueue: DispatchQueue = DemoAPI.apiResponseQueue, completion: @escaping ((_ data: Pet?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func updatePetWithForm(petId: Int64, name: String? = nil, status: String? = nil, apiResponseQueue: DispatchQueue = DemoAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func uploadFile(petId: Int64, additionalMetadata: String? = nil, file: URL? = nil, apiResponseQueue: DispatchQueue = DemoAPI.apiResponseQueue, completion: @escaping ((_ data: ApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func uploadFileWithRequestBuilder(petId: Int64, additionalMetadata: String? = nil, file: URL? = nil) -> RequestBuilder<ApiResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ApiResponse>.Type = DemoAPI.requestBuilderFactory.getBuilder()
