...
class BaseApi(api_client.Api):
    ...
    def _object_instead_of_scalar_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aobject_instead_of_scalar_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object-instead-of-scalar',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _object_instead_of_scalar_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class ObjectInsteadOfScalarRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aobject_instead_of_scalar(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        return await self._aobject_instead_of_scalar_oapg(
            **kwargs,
        )
...
class ObjectInsteadOfScalar(BaseApi):
