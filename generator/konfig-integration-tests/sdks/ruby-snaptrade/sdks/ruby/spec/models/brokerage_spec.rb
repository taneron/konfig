...
# Unit tests for SnapTrade::Brokerage
describe SnapTrade::Brokerage do
  let(:instance) { SnapTrade::Brokerage.new }

  describe 'test an instance of Brokerage' do
    it 'should create an instance of Brokerage' do
      expect(instance).to be_instance_of(SnapTrade::Brokerage)
    end
  end
