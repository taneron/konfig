...
class BaseApi(api_client.Api):
    ...
    def _list_instead_of_scalar_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_instead_of_scalar_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/list-instead-of-scalar',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_instead_of_scalar_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class ListInsteadOfScalarRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_instead_of_scalar(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_instead_of_scalar_mapped_args(
        )
        return await self._alist_instead_of_scalar_oapg(
            **kwargs,
        )
    ...
    def list_instead_of_scalar(
        ...
        return self._list_instead_of_scalar_oapg(
        )

class ListInsteadOfScalar(BaseApi):
    ...
    async def alist_instead_of_scalar(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_instead_of_scalar(
            **kwargs,
        )
        if validate:
