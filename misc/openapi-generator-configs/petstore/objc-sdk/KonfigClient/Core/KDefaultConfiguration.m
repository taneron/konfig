...
#import "KBasicAuthTokenProvider.h"
#import "KLogger.h"

@interface KDefaultConfiguration ()
...
@implementation KDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static KDefaultConfiguration *shardConfig = nil;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [KBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
