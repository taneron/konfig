...
class InstallmentPlanCreateResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DateCreated", "Status", "InstallmentPlanNumber", "RefOrderNumber", "PurchaseMethod", "Currency", "OriginalAmount", "Amount", "ExtendedParams", "Authorization", "Shopper", "BillingAddress", "PaymentMethod", "Installments", "Links", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DateCreated", "Status", "InstallmentPlanNumber", "RefOrderNumber", "PurchaseMethod", "Currency", "OriginalAmount", "Amount", "ExtendedParams", "Authorization", "Shopper", "BillingAddress", "PaymentMethod", "Installments", "Links", ], str]):
