...
public abstract class AbstractPythonCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public String toOperationId(String operationId) {
        ...
        // I commented the below code because reserved words should be caught at the linter level anyways - Dylan
...
//        }
    ...
    public String toApiFilenameGenerated(String name) {
        return toApiFilename(name) + "_generated";
    }
