...
NAME = "python-ignore-pydantic-protected-namespaces"
VERSION = "1.0.0"
...
setup(
    name=NAME,
    version=VERSION,
    description="python-ignore-pydantic-protected-namespaces API",
    author="API Support",
    author_email="support@example.com",
    url="https://github.com/konfig-dev/konfig/tree/main/python",
    keywords=["Konfig", "python-ignore-pydantic-protected-namespaces API"],
    python_requires=">=3.7",
